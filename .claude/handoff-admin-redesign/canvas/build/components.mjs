...
const CSS = `
    ...
    .skel { border-radius:var(--r-xs); background:linear-gradient(90deg,var(--stone-100),var(--stone-200),var(--stone-100)); }
    ...
    .prog i { display:block; height:100%; background:var(--success-500); }
