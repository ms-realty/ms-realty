...
const F_CSS = `
    ...
    .doc-hd p { margin-top:5px; font-size:13.5px; color:var(--text-muted); max-width:700px; }
    .lane { display:grid; grid-template-columns:132px minmax(0,1fr); gap:0; border:1px solid var(--border);
      border-radius:var(--r-lg); overflow:hidden; background:var(--surface); margin-bottom:14px; }
    .lane-l { background:var(--stone-50); border-right:1px solid var(--border); padding:14px 14px;
      display:grid; align-content:start; gap:4px; }
    .lane-l b { font-size:12.5px; font-weight:600; color:var(--text-strong); }
    .lane-l span { font-size:11px; color:var(--text-muted); }
    .lane-r { padding:14px; display:flex; align-items:center; gap:0; flex-wrap:wrap; }
    .node { display:grid; gap:4px; min-width:150px; max-width:186px; padding:10px 12px; border-radius:var(--r-md);
      border:1px solid var(--border); background:var(--surface); }
    .node b { font-size:12px; font-weight:600; color:var(--text-strong); line-height:1.3; }
    ...
    .legend { display:flex; gap:16px; flex-wrap:wrap; font-size:12px; color:var(--text-muted); margin-top:6px; }
    .legend span { display:inline-flex; align-items:center; gap:7px; }
    .key { width:13px; height:13px; border-radius:3px; border:1px solid; flex:0 0 auto; }
    .grp > h2 { font-size:12px; font-weight:600; color:var(--text-muted); margin:22px 0 10px;
