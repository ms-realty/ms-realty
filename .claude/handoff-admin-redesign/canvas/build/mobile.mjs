...
const M_CSS = `
    ...
    .ph-bar { display:flex; align-items:center; gap:10px; padding:12px 14px 10px; background:var(--surface);
      border-bottom:1px solid var(--border); }
    .ph-bar h1 { font-family:var(--font-display); font-size:19px; font-weight:600; letter-spacing:-.01em;
      flex:1 1 auto; min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
    .ph-ic { display:grid; place-items:center; width:44px; height:44px; border-radius:12px;
      border:1px solid var(--border); background:var(--surface); color:var(--text-body); flex:0 0 auto; }
    .ph-ic--plain { border-color:transparent; }
    .ph-body { flex:1 1 auto; display:grid; gap:10px; padding:12px 14px 16px; align-content:start; }
    ...
    .ph-kv { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:10px; }
    .ph-kv dt { font-size:11px; color:var(--text-muted); margin-bottom:2px; }
    ...
    .ph-msg { padding:11px 13px; border-radius:12px; font-size:12.5px; line-height:1.55; }
    .ph-msg--in { background:var(--stone-100); color:var(--text-body); border-bottom-left-radius:4px; }
    ...
    .ph-tab[data-on] { color:var(--stone-900); }
    ...
    .ph-tab u { position:absolute; top:4px; right:16px; min-width:16px; height:16px; padding:0 4px;
      border-radius:999px; background:var(--brick-600); color:#fff; font-size:9.5px; font-weight:700;
      line-height:16px; text-align:center; text-decoration:none; }
    .ph-step { display:grid; grid-template-columns:auto minmax(0,1fr); gap:11px; align-items:start;
      padding:10px 0; border-bottom:1px solid var(--border); }
    .ph-step:last-child { border-bottom:0; }
    .ph-step b { font-size:12.5px; font-weight:600; display:block; }
    .ph-step em { font-style:normal; font-size:11.5px; color:var(--text-muted); }
`;
...
const LEAD = `<div class="ph-app">
  ...
  <div class="ph-body">
    ...
    <div class="ph-card">
      ...
      <p style="font-size:11.5px; color:var(--warning-700)">${icon("alert", 12)} WhatsApp is not connected — this will be marked ready to send by hand.</p>
    </div>
    ...
    <div class="ph-card">
      ...
      <span class="ph-btn ph-btn--g" style="width:auto; min-height:44px; padding:0 14px">Add what she told you</span>
    </div>
  </div>
${tabs("inbox")}
</div>`;
...
const CASE = `<div class="ph-app">
  ...
  <div class="ph-body">
    <div class="ph-card">
      ...
      <p style="font-size:12.5px; color:var(--text-muted)">Buyer purchase · Bulgaria · notary 8 September, 11:00</p>
      <div style="height:6px; border-radius:999px; background:var(--stone-200); overflow:hidden">
        <i style="display:block; height:100%; width:64%; background:var(--success-500)"></i></div>
      <p style="font-size:12px; color:var(--text-muted)">14 of 22 steps resolved · 1 blocked</p>
    </div>

    <div class="ph-card" style="border-color:var(--danger-600)">
      <div style="display:flex; align-items:center; gap:8px">
        <span class="pill pill--danger"><i></i>Blocked</span>
        <span style="font-size:11.5px" class="muted">3 days</span>
      </div>
      <b style="font-size:13.5px">Proof of funds from the buyer's bank</b>
      <p style="font-size:12.5px; color:var(--text-muted)">Requested 29 August. The preliminary contract cannot be signed without it.</p>
      <div class="ph-row">
