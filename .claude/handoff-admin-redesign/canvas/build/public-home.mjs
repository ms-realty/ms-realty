...
const BODY = `${pubHeader("")}
  ...
  <section class="sec"><div class="pub-wrap">
    ...
    <div class="cards">
${CARD("185 000 €", "Вила с басейн и изглед към планината", "Катунци", "MS-CRAWL-0114", "4 спални", "214 м²", "днес", "ok", "Нова")}
${CARD("68 000 €", "Двустаен апартамент с южна тераса", "Сандански", "MS-CRAWL-0001", "2 спални", "72 м²", "преди 2 дни", "sea", "Гледана 34 пъти")}
${CARD("54 500 €", "Реновирана селска къща с двор", "Катунци", "MS-CRAWL-0032", "3 спални", "96 м²", "преди 3 дни", "warn", "Намалена")}
    </div>
  </div></section>
