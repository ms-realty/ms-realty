...
const CSS = `
    ...
    .mtop { display:flex; align-items:center; gap:12px; padding:14px 16px; border-bottom:1px solid var(--border); }
    .mtop img { display:block; height:30px; width:auto; }
    .mic { display:grid; place-items:center; width:44px; height:44px; border-radius:12px;
    ...
    .mcall { display:inline-flex; align-items:center; justify-content:center; width:44px; height:44px;
      border-radius:12px; background:var(--brick-600); color:#fff; flex:0 0 auto; }
    .mbody { flex:1 1 auto; display:grid; gap:14px; padding:16px; align-content:start; }
    .msearch { display:grid; gap:9px; padding:14px; border-radius:var(--r-lg); background:var(--stone-100); }
    .mfield { display:flex; align-items:center; justify-content:space-between; gap:10px; min-height:50px;
      padding:0 14px; border-radius:var(--r-md); background:var(--surface); border:1px solid var(--border-control);
      font-size:15px; font-weight:600; color:var(--stone-900); }
    .mbtn { display:inline-flex; align-items:center; justify-content:center; gap:9px; min-height:50px;
      padding:0 18px; border-radius:var(--r-md); background:var(--brick-600); color:#fff; font-size:15.5px;
      font-weight:600; border:1px solid var(--brick-600); }
    .mbtn--g { background:var(--surface); border-color:var(--border-control); color:var(--stone-900); }
    .mbtn--d { background:var(--ink-800); border-color:var(--ink-800); color:#fff; }
    .mchips { display:flex; gap:8px; overflow:hidden; }
    .mchip { display:inline-flex; align-items:center; gap:7px; height:40px; padding:0 14px; border-radius:999px;
    ...
    .mcard .fav { position:absolute; z-index:1; top:10px; right:10px; display:grid; place-items:center;
      width:44px; height:44px; border-radius:999px; background:rgba(255,255,255,.94); color:var(--ink-800); }
    .mcard .bd { padding:14px 15px 16px; display:grid; gap:8px; }
    .mcard .p { font-family:var(--font-display); font-size:22px; font-weight:600; color:var(--stone-900); }
    .mcard h3 { font-size:16px; font-weight:600; color:var(--stone-900); line-height:1.35; }
    .mfacts { display:flex; flex-wrap:wrap; gap:12px; font-size:14px; color:var(--text-muted); }
    .mfacts span { display:inline-flex; align-items:center; gap:6px; }
    .mtabs { margin-top:auto; display:grid; grid-template-columns:repeat(4,1fr); gap:2px;
      padding:8px 8px 22px; background:var(--surface); border-top:1px solid var(--border); }
    .mtab { display:grid; justify-items:center; gap:4px; min-height:54px; padding:8px 2px; border-radius:12px;
      color:var(--text-muted); font-size:11px; font-weight:600; }
    .mtab[data-on] { color:var(--stone-900); }
    .mtab[data-on] svg { color:var(--brick-600); }
    .mbar { position:sticky; bottom:0; display:flex; gap:10px; padding:12px 16px 20px;
    ...
    .mgal .cnt { position:absolute; z-index:1; right:12px; bottom:12px; display:inline-flex; align-items:center;
      gap:7px; height:34px; padding:0 12px; border-radius:var(--r-md); background:rgba(255,255,255,.94);
      font-size:13.5px; font-weight:600; color:var(--stone-900); }
    .mgal .back { position:absolute; z-index:1; left:12px; top:12px; display:grid; place-items:center;
      width:44px; height:44px; border-radius:999px; background:rgba(255,255,255,.94); color:var(--stone-900); }
    .mkv { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:1px; background:var(--border);
      border:1px solid var(--border); border-radius:var(--r-md); overflow:hidden; }
    .mkv > div { background:var(--surface); padding:12px 14px; }
    .mkv dt { font-size:13px; color:var(--text-muted); margin-bottom:3px; }
    .mkv dd { margin:0; font-size:16px; font-weight:600; color:var(--stone-900); }
`;
...
const SEARCH = `<div class="m">
  ...
  <div class="mbody">
    ...
    <p class="meta" style="font-size:14px">18 обяви в Сандански</p>
...
const LISTING = `<div class="m">
  ...
  <div class="mbody">
    <div>
      <span style="font-family:var(--font-display); font-size:26px; font-weight:600; color:var(--stone-900)">185 000 €</span>
      <h1 style="font-size:19px; font-weight:600; color:var(--stone-900); line-height:1.35; margin-top:6px">Вила с басейн и изглед към планината</h1>
      <p style="font-size:15px; color:var(--text-muted); margin-top:5px">Катунци, община Сандански</p>
    </div>
    ...
    <p style="font-size:15.5px; line-height:1.65; color:var(--text-body)">Двуетажна вила в края на Катунци,
      на 14 км от Сандански. Собствен двор с басейн, лятна кухня и гараж за две коли.</p>
    <a href="#" style="font-size:15px; font-weight:600">Прочетете още ${icon("down", 15)}</a>
...
const HE = `<div class="m">
  ...
  <div class="mbody">
    <div>
      <span style="font-family:var(--font-display); font-size:26px; font-weight:600; color:var(--stone-900)" dir="ltr">€185,000</span>
      <h1 style="font-size:19px; font-weight:600; color:var(--stone-900); line-height:1.45; margin-top:6px">וילה עם בריכה ונוף להרים</h1>
      <p style="font-size:15px; color:var(--text-muted); margin-top:5px">קטונצי, אזור סנדנסקי</p>
    </div>
    <div style="display:flex; flex-wrap:wrap; gap:8px">
    ...
    <p style="font-size:15.5px; line-height:1.7; color:var(--text-body)">וילה דו-קומתית בקצה הכפר קטונצי,
      14 ק״מ מסנדנסקי. חצר פרטית עם בריכה, מטבח קיץ וחניה מקורה לשתי מכוניות.</p>
    <a href="#" style="font-size:15px; font-weight:600">קראו עוד ${icon("down", 15)}</a>
