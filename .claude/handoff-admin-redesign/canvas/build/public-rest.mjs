...
const LOC_BODY = `${pubHeader("loc")}
  <div class="pub-wrap">
    ...
    <section class="sec--tight">
      ...
      <div class="cards">
${CARD("68 000 €", "Двустаен апартамент с южна тераса", "Център", "MS-CRAWL-0001", "2 спални", "72 м²")}
${CARD("31 900 €", "Студио до минералните бани", "Сандански", "MS-CRAWL-0087", "1 спалня", "38 м²")}
${CARD("120 000 €", "Търговски обект на главната", "Център", "MS-CRAWL-0158", "—", "88 м²")}
      </div>
    </section>
  </div>
${pubFooter()}`;
...
const SELL_BODY = `${pubHeader("sell")}
  ...
  <div class="pub-wrap">
    ...
    <section class="sec--tight" style="border-top:1px solid var(--border)">
      ...
      <div class="cards">
${CARD("96 000 €", "Къща с двор, продадена за 6 седмици", "Сандански", "MS-CRAWL-0203", "3 спални", "146 м²")}
${CARD("62 000 €", "Двустаен, продаден на първия оглед", "Сандански", "MS-CRAWL-0198", "2 спални", "68 м²")}
${CARD("188 000 €", "Вила, купувач от Гърция", "Катунци", "MS-CRAWL-0181", "4 спални", "204 м²")}
      </div>
    </section>
  </div>
${pubFooter()}`;
