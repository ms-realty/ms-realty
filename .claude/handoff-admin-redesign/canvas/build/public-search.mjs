...
const BODY = `${pubHeader("search")}
  ...
  <div class="split2">
    <div class="results">
      ...
      <div class="rgrid">
${CARD("68 000 €", "Двустаен апартамент с южна тераса", "Сандански, център", "MS-00815", "2 спални", "72 м²", "Нова", "ok", "Обновена днес")}
${CARD("72 400 €", "Апартамент с покрито паркомясто", "Сандански", "MS-00499", "2 спални", "84 м²", "", "", "Обновена преди 6 дни")}
${CARD("31 900 €", "Студио до минералните бани", "Сандански", "MS-00791", "1 спалня", "38 м²", "Намалена", "warn", "Обновена преди 3 дни")}
${CARD("54 500 €", "Тристаен след основен ремонт", "Сандански, Спортна", "MS-00896", "3 спални", "96 м²", "", "", "Обновена вчера")}
${CARD("89 000 €", "Мезонет с две тераси", "Сандански", "MS-00280", "3 спални", "118 м²", "360° тур", "sea", "Обновена преди 2 дни")}
