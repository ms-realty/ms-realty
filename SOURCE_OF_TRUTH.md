...
| **P2 · Production public site** | Server-rendered routes, listing/search/location/seller/contact pages, hreflang/canonical/schema, sitemap gen | **Contracts + stdlib HTML adapter + App Router manifest built**; actual Next.js app shell pending |
