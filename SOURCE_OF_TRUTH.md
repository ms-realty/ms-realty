...
| **P6 · Launch readiness** | Production crawl diff; redirect-chain + sitemap/robots + schema validation; accessibility QA; performance budgets; analytics + monitoring; rollback plan | Launch-readiness report aggregates gates; redirect reviews are locally complete; **blocked on external SEO exports and live service reports** |
...
`migration/external/seo/`, plus live Typesense/Meilisearch sync/query and Hermes draft-worker reports.
Redirect reviews are locally complete and covered by the reviewed deployable 301 export.
