...
| 42 | Конкурентный и open-source анализ не был связан с решениями продукта. | Сравнение Airbnb, Booking, Imot/ImotiBG и релевантных open-source решений зафиксировано отдельно; в продукт перенесены паттерны progressive disclosure, map/search continuity, stable cards, saved search и guided operator workflow без копирования бренда/кода. | historical: [`COMPETITIVE_RESEARCH_RU.md` at 9fec19ce](https://github.com/ms-realty/ms-realty/blob/9fec19ce2648b5599cc609bc111a9b5b098def06/production/COMPETITIVE_RESEARCH_RU.md) (removed from the active tree) и реализованные regressions. |
