    ...
    collections: [
      ...
      },
      {
        ...
        fields: [
          ...
          collectionField("asset_id", "text", { unique: true, index: true, maxLength: 160 }),
          collectionField("upload_id", "text", { unique: true, index: true, maxLength: 200, admin: { hidden: true } }),
          collectionField("subject_type", "text", { maxLength: 32, admin: { hidden: true } }),
          collectionField("subject_id", "text", { maxLength: 160, index: true, admin: { hidden: true } }),
          collectionField("source_url", "url"),
          ...
          collectionField("kind", "select", {
            required: true,
            options: ["photo", "floor_plan", "video", "site_chrome", "document", "unknown"],
          }),
          ...
          collectionField("storage_driver", "text", { maxLength: 40, admin: { hidden: true } }),
          collectionField("storage_key", "text", { maxLength: 512, admin: { hidden: true } }),
          collectionField("rendition", "json", { admin: { hidden: true } }),
          collectionField("content_hash", "text", { maxLength: 128, admin: { hidden: true } }),
          collectionField("format", "text", { maxLength: 32, admin: { hidden: true } }),
          collectionField("content_type", "text", { maxLength: 120, admin: { hidden: true } }),
          collectionField("bytes", "number", { admin: { hidden: true } }),
          collectionField("submitted_bytes", "number", { admin: { hidden: true } }),
          collectionField("bytes_before", "number", { admin: { hidden: true } }),
          collectionField("bytes_after", "number", { admin: { hidden: true } }),
          collectionField("optimized", "checkbox", { admin: { hidden: true } }),
          collectionField("orientation_applied", "checkbox", { admin: { hidden: true } }),
          collectionField("resized", "checkbox", { admin: { hidden: true } }),
          collectionField("metadata_stripped", "checkbox", { admin: { hidden: true } }),
          collectionField("metadata_removed_bytes", "number", { admin: { hidden: true } }),
          collectionField("uploaded_at", "date", { admin: { hidden: true } }),
          collectionField("uploaded_by", "text", { maxLength: 160, admin: { hidden: true } }),
          collectionField("source", "text", { maxLength: 120, admin: { hidden: true } }),
          collectionField("replaces_asset_id", "text", { maxLength: 160 }),
          collectionField("replacement_asset_id", "text", { maxLength: 160 }),
          collectionField("reviewer", "text", { maxLength: 160 }),
          collectionField("reviewed_at", "date"),
          collectionField("review_decision", "select", { options: ["publish", "keep_private"] }),
          collectionField("human_confirmed", "checkbox", { admin: { hidden: true } }),
          collectionField("review_history", "json", { admin: { hidden: true } }),
        ],
      },
      {
        slug: "listing_tours",
