...
const ACTION_LABELS = {
  bg: {
    ...
    hermesAssistant: "Асистент Hermes",
    hermesAsk: "Попитайте за имот или района",
    hermesPlaceholder: "Напр. апартамент в Сандански до 100 000 EUR",
    hermesSend: "Попитай",
    hermesThinking: "Hermes подготвя отговор...",
    hermesUnavailable: "Hermes не можа да отговори. Опитайте отново или се свържете с брокер.",
    hermesSources: "Одобрени източници",
  ...
  en: {
    ...
    hermesAssistant: "Hermes assistant",
    hermesAsk: "Ask about a property or area",
    hermesPlaceholder: "For example, apartment in Sandanski up to EUR 100,000",
    hermesSend: "Ask",
    hermesThinking: "Hermes is preparing an answer...",
    hermesUnavailable: "Hermes could not answer. Try again or contact a broker.",
    hermesSources: "Approved sources",
  ...
  de: {
    ...
    hermesAssistant: "Hermes-Assistent",
    hermesAsk: "Fragen Sie nach einer Immobilie oder Gegend",
    hermesPlaceholder: "Zum Beispiel Wohnung in Sandanski bis 100.000 EUR",
    hermesSend: "Fragen",
    hermesThinking: "Hermes bereitet eine Antwort vor...",
    hermesUnavailable: "Hermes konnte nicht antworten. Versuchen Sie es erneut oder kontaktieren Sie einen Makler.",
    hermesSources: "Genehmigte Quellen",
  ...
  nl: {
    ...
    hermesAssistant: "Hermes-assistent",
    hermesAsk: "Vraag naar een object of omgeving",
    hermesPlaceholder: "Bijvoorbeeld appartement in Sandanski tot EUR 100.000",
    hermesSend: "Vraag",
    hermesThinking: "Hermes bereidt een antwoord voor...",
    hermesUnavailable: "Hermes kon niet antwoorden. Probeer opnieuw of neem contact op met een makelaar.",
    hermesSources: "Goedgekeurde bronnen",
  ...
  ru: {
    ...
    hermesAssistant: "Ассистент Hermes",
    hermesAsk: "Спросите об объекте или районе",
    hermesPlaceholder: "Например, квартира в Сандански до 100 000 EUR",
    hermesSend: "Спросить",
    hermesThinking: "Hermes готовит ответ...",
    hermesUnavailable: "Hermes не смог ответить. Попробуйте ещё раз или свяжитесь с брокером.",
    hermesSources: "Одобренные источники",
  ...
  el: {
    ...
    hermesAssistant: "Βοηθός Hermes",
    hermesAsk: "Ρωτήστε για ακίνητο ή περιοχή",
    hermesPlaceholder: "Για παράδειγμα, διαμέρισμα στο Σαντάνσκι έως 100.000 EUR",
    hermesSend: "Ρωτήστε",
    hermesThinking: "Το Hermes ετοιμάζει απάντηση...",
    hermesUnavailable: "Το Hermes δεν μπόρεσε να απαντήσει. Δοκιμάστε ξανά ή επικοινωνήστε με μεσίτη.",
    hermesSources: "Εγκεκριμένες πηγές",
  ...
  he: {
    ...
    hermesAssistant: "עוזר Hermes",
    hermesAsk: "שאלו על נכס או אזור",
    hermesPlaceholder: "לדוגמה, דירה בסנדנסקי עד 100,000 אירו",
    hermesSend: "שאלו",
    hermesThinking: "Hermes מכין תשובה...",
    hermesUnavailable: "Hermes לא הצליח להשיב. נסו שוב או צרו קשר עם מתווך.",
    hermesSources: "מקורות מאושרים",
  ...
  return {
    ...
    body: {
      ...
      valuation: {
        ...
        method: "POST",
        minimum_tap_target_px: 44,
        required_fields: ["contact.name", "property.location", "property.type", "message"],
        payload: {
