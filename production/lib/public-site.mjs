...
const SELLER_COPY = {
  bg: {
    ...
    photos_reference_toggle: "Вече имате номер на запитване?",
  ...
  en: {
    ...
    photos_reference_toggle: "Already have an enquiry reference?",
  ...
  de: {
    ...
    photos_reference_toggle: "Sie haben schon eine Anfragenummer?",
  ...
  nl: {
    ...
    photos_reference_toggle: "Heeft u al een aanvraagnummer?",
  ...
  ru: {
    ...
    photos_reference_toggle: "Уже есть номер обращения?",
  ...
  el: {
    ...
    photos_reference_toggle: "Έχετε ήδη αριθμό αιτήματος;",
  ...
  he: {
    ...
    photos_reference_toggle: "כבר יש לכם מספר פנייה?",
...
const CHROME_COPY = {
  ...
  nl: {
    ...
    languageLabel: "Taal",
    themeLabel: "Weergave",
    themeSystem: "Systeeminstelling volgen",
      ...
      photo_upload: photoUploadDisabled
        ...
        : {
            ...
            copy: {
              ...
              reference_toggle: copy.photos_reference_toggle,
