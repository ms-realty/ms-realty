...
const ADMIN_UI_COPY = {
  bg: {
    ...
    statuses: {
      ...
      available: "Налична", source_imported_review_required: "Внесена от източник - изисква преглед", review_required: "Изисква преглед",
    },
  ...
  ru: {
    ...
    statuses: {
      ...
      available: "Доступно", source_imported_review_required: "Импортировано из источника - нужна проверка", review_required: "Требует проверки",
    },
  ...
  en: {
    ...
    statuses: {
      ...
      available: "Available", source_imported_review_required: "Imported from source - review required", review_required: "Review required",
    },
      ...
      h(
        ...
        h(StatGrid, {
          metrics: [
            ...
            [
              label(copy, "mediaReview", "Media review"),
              statusText(ui, page.listing.tour?.available ? "available" : "review_required"),
              "globe",
              page.listing.tour?.available ? "success" : "sun",
            ],
          ],
        }),
      ),
