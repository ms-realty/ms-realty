#!/usr/bin/env node
// Generates production/lib/ui/design-assets.mjs and production/lib/ui/icon-data.mjs
...
// Source of truth: makler-realty-design-system/project (tokens, components, ui_kits) + production/lib/ui/adapter.css
...
console.log(JSON.stringify({ kind: "design_assets", hash, css_bytes: css.length, icons: Object.keys(icons).length }));
