...
test("generated localized sitemap file is approved-translation gated when present", () => {
  ...
  assert.equal(data.summary.byLocale.bg, 117);
  assert.equal(data.summary.byLocale.ru, 56);
  assert.equal(data.summary.byLocale.el, 4);
  assert.equal(data.summary.byLocale.he, 4);
