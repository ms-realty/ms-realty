...
test("public client loads the pinned local Photo Sphere Viewer bundle only for approved HTTPS panorama markup", () => {
  ...
  const publicStyles = new URL("../../public/vendor/ms-realty-public.css", import.meta.url);
  const adminStyles = new URL("../../public/vendor/ms-realty-admin.css", import.meta.url);
  ...
  for (const styles of [publicStyles, adminStyles]) {
    ...
    assert.match(fs.readFileSync(styles, "utf8"), /data-mobile-sticky-actions/);
  }
