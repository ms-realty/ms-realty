...
test("structured data warnings use broker-verified property edits", () => {
  ...
  assert.equal(reviewed.summary.warnings.missing_price, base.summary.warnings.missing_price - 1);
  assert.equal(reviewed.summary.warnings.missing_area, base.summary.warnings.missing_area - 1);
